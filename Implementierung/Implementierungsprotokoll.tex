...
\begin{equation}
	avgAccX_i = (avgAccX_{i-1} \cdot weight + AccX_i) /(weight + 1)
\end{equation}
...
\begin{equation}
	cos(\alpha) = \frac{avgAccX \cdot AccX + avgAccY \cdot AccY + avgAccZ \cdot AccZ}{ AccAbs \cdot AvgAccAbs },
\end{equation}
