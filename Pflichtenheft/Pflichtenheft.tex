...
Erst nach dem Bestehen aller hier aufgeführten Tests und Szenarien ist das Produkt bereit für die Abnahme.
  ...
  \begin{itemize}
    ...
    \item[/T040/] Die Datenaufnahme des \Gls{IMU} wird gestartet. Die Daten werden korrekt empfangen. %changed
    \item[/T050/] Die Datenaufnahme des \Gls{IMU} wird gestoppt.
  \end{itemize}
  \paragraph{Erweiterungsmodul}
  \begin{itemize}
    \item[/T060/] Der Nutzer tätigt einen Schritt. Das Modul registriert einen Schritt.
    \item[/T061/] Der Nutzer läuft mit einem Schritt pro Sekunde.
    \item[/T062/] Der Nutzer tätigt drei Schritte. Das Modul registriert drei mal einen Schritt. %changed
    \item[/T063/] Das Erweiterungsmodul berechnet nach 20 Schritten und einer eingestellten Schrittlänge von 70 cm die zurückgelegte Distanz von 14 Metern korrekt.
  \end{itemize}
  \paragraph{App}
    \begin{itemize}
    \item[/T070/] Der Nutzer startet die App über sein Smartphone und landet im Laufmodus.
    \item[/T075/] Der Nutzer startet den modusspezifischen \Gls{Vorgang}. Die App zeigt an, dass der Vorgang läuft. %changed
    ...
    \item[/T104/] Der Nutzer startet den Laufmodus. Er läuft 20 Schritte. Er beendet den Laufmodus. Er beendet die App und startet sie neu. Im Laufmodus wird ihm nun unter anderem die zurückgelegte Anzahl Schritte (20) angezeigt.
    ...
    \item[/T160/] Der Nutzer klickt das Pop Up weg. Die App zeigt die selbe Ansicht wie vor dem Erscheinen des Popups. %changed
...
\subsubsection{Wunschanforderungen}
  \paragraph{Erweiterungsmodul}
    \begin{itemize}
    \item[/T170/] Der Nutzer macht einen Sit-up. Das Modul erkennt einen Sit-up. %changed
    \item[/T180/] Der Nutzer macht eine Liegestütze. Das Modul erkennt eine Liegestütze. %changed
  \end{itemize}
  \paragraph{App}
  \begin{itemize}
    \item[/T200/] Die Liegestützen oder Sit-ups werden von der App gezählt und im Modus \glqq{}Zählmodus \grqq{} angezeigt.
    \item[/T210/] Der Nutzer bleibt stehen, die Musik stoppt. Der Nutzer läuft weiter, die Musik läuft weiter.
    ...
    \item[/T223/] Nach Vorgangsende des Modus' Lauschen und Agieren wird die Zeit angezeigt, die der \Gls{Vorgang} aktiv war. %changed
    \item[/T250/] Der Nutzer ändert seinen Namen.
    \item[/T260/] Der Nutzer ändert die Sprache auf Englisch. Nach Neustart der App sind alle Texte auf Englisch. %changed
    \item[/T265/] Der Nutzer ruft erstmals die App auf. Die Sprache der App passt sich seiner Systemsprache an. %changed
    \item[/T270/] Der Nutzer löscht die Vorgangsdaten. Er wechselt zur Datenansicht und ihm werden keine Einträge angezeigt. %changed
    \item[/T280/] Der Nutzer verändert die Samplingrate. Die Samplingrate wird im \Gls{IMU} auf den korrekten Wert eingestellt. %changed
    \item[/T285/] Der Nutzer ändert die Schrittlänge. Die App speichert die Änderung korrekt. %changed
    \item[/T290/] Der Nutzer ruft erstmals die App auf, er wird aufgefordert seinen Namen und seine Schrittlänge zu setzen.
    \item[/T300/] Der Nutzer importiert seine Vorgangsdaten aus einer CSV-Datei. Er wechselt zur Datenansicht und ihm werden die korrekten Einträge angezeigt. %changed
