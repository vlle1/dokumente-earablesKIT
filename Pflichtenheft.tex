...
\section{Funktionale Anforderungen}
  \subsection{Mussanforderungen}
    ...
    \begin{itemize}
      \item[/F010/] Daten des \Gls{6-Achsen IMU} in \Gls{Echtzeit} zur Verfügung stellen.
  ...
  \subsection{Wunschanforderungen}
    ...
    \subsubsection{App}
      ...
      Einstellungen:
      \item[/F250/] Der Nutzer kann seinen Namen abgeben und ändern.
...
Die \Gls{GUI} wird durch die App realisiert. Dabei kann man die einzelnen Modi über das Navigationsmenu auswählen. Jeder Modus hat zwei Seiten; eine Übersichtsseite und eine aktive Seite, welche während des aktiven \Gls{Vorgang} angezeigt wird. Für die weiteren Funktionen(Einstellungen, Dateienexport/-import) bietet die Applikation ebenfalls spezielle Seiten an.
Die \Gls{GUI} kann getestet werden mithilfe des Design-Tools "Mock-up" über den angegebenen Link in der Fußnote \footnote[1]{Mock-Up Prototyp: https://app.moqups.com/448nRiafse/view/page/a70dc1e41?ui=0}
...
%%TODO David
  \subsection{Globale Testfälle}
    ...
    \begin{itemize}
	\item[/Txxx/] Die Sensorrohdaten werden als Graphen angezeigt. (/190/)
	\item[/Txxx/] Die Liegestützen oder Sit-ups werden von der App gezählt. (/200/)
	\item[/Txxx/] Einen Trainingsplan zusammenstellen. (/F221/)
	\item[/Txxx/] Die App gibt dem Nutzer über Sprachanweisung aus was die nächste Übung ist. (/F222/)
	\item[/Txxx/] Nach der Übung wird die benötigte Zeit angezeigt. (/F223/)
	\item[/Txxx/] Der Nutzer ändert seinen Namen. (/F250/)
	\item[/Txxx/] Der Nutzer ändert die Sprache. (/F260/)
	\item[/Txxx/] Trainingsdaten löschen. (F270)
	\item[/Txxx/] Die Samplingrate verändern. (/F280/)
	\item[/Txxx/] Die Schrittlänge verändern. (/F285/)
	\item[/Txxx/] Bei der Erstnutzung wird der Nutzer aufgefordert seinen Namen, seine Schrittlänge und die Sprache zu setzen. (/F290/, /F250/)
	\item[/Txxx/] Trainingsdaten importieren und expotrieren. (/F300/)
	\item[/Txxx/] Die gespeicherten Trainingsdaten ansehen. (/310/, /320/)
   \end{itemize}
  ...
  \subsection{Szenarien}
    ...
    \subsubsection{Wunschanforderungen}
      ...
      \begin{itemize}
        ...
        \item[] Dem Nutzer löscht die gespeicherten \Gls{Vorgangsdaten} (/F270/).
