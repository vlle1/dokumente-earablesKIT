...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item wenn ein Modus gestartet werden soll oder andere Aktivitäten erfolgen (z.b. \Gls{Steuerungsparameter} anpassen), aber gerade keine BLE-Verbindung existiert.
  \end{itemize}
