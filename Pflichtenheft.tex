  ...
  \subsection{Anwendungsbereiche}
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item[] Auswerten der von \Gls{Earables} generierten Daten für die Verwendung in einer App z.B. im Bereich Fitness
      \end{itemize}
...
\section{Funktionale Anforderungen}
  \subsection{Mussanforderungen}
    ...
    \subsubsection{App}
      ...
      \item[/F132/] \textsf {Schrittfrequenz Anzeigen:} Es wird die Schrittfrequenz im Modus \glqq{}Laufmodus\grqq{} angezeigt, sobald der Modus gestartet wird. Die Schrittfrequenz wird mit Hilfe von /F140/ ermittelt.%% lezten Satz in NA ?? das gleiche bei F134
  ...
  \subsection{Wunschanforderungen}
    \subsubsection{Erweiterungsmodul}
      ...
      \begin{itemize}
      \item[/F170/] \textsf{Erkennung Sit-ups} Das Erweiterungsmodul erkennt wann der \gls{Nutzer} Sit-ups macht.
      \item[/F180/] \textsf{Erkennung Liegestütze} Das Erweiterungsmodul erkennt wann der \gls{Nutzer} Liegestütze macht.
      \end{itemize} 
    \subsubsection{App}
      Weitere Modi:
      \begin{itemize}
  ...
  \subsection{Szenarien}
    ...
    \paragraph{Start/Stop Musikmodus (/F210/)}
      ...
      \begin{enumerate}
        ...
        \item Der Nutzer wird aufgefordert seinen Namen, seine Schrittlänge und die in-App Sprache zu setzen. (/T290/)
