...
%%TODO David
  ...
  \begin{itemize}
    \item[/T060/] Der Nutzer tätigt einen Schritt. Das Modul registriert diesen korrekt. %changed
    \item[/T061/] Der Nutzer läuft mit einem Schritt pro Sekunde.
    \item[/T062/] Der Nutzer tätigt drei Schritte. Das Modul registriert diese korrekt. %changed
    \item[/T063/] Der Nutzer läuft einen Meter. %TODO
  \end{itemize}
  \paragraph{App}
    \begin{itemize}
    ...
    \item[/T104/] Die App befindet sich im Laufmodus und der Laufmodus ist noch nicht gestartet. Es wird angezeigt, wie viele Schritte der Nutzer beim letzten Vorgang gemacht hat und welche Strecke er dabei zurückgelegt hat. %TODO
    ...
    \item[/T160/] Der Nutzer klickt das Pop Up weg. Die App kehrt zum vorherigen Vorgang zurück. %changed
...
\subsubsection{Wunschanforderungen}
  \paragraph{Erweiterungsmodul}
    \begin{itemize}
    \item[/T170/] Der Nutzer macht einen Sit-up. Das Modul registriert diese Aktivität. %changed
    \item[/T180/] Der Nutzer macht eine Liegestütze. Das Modul registriert diese  Aktivität. %changed
  \end{itemize}
  \paragraph{App}
  \begin{itemize}
    ...
    \item[/T270/] Der Nutzer löscht die Vorgangsdaten. Die Vorgangsdaten sind danach nicht mehr einsehbar. %changed
    ...
    \item[/T285/] Der Nutzer ändert die Schrittlänge. Die App speichert die Änderung. %changed
    \item[/T290/] Der Nutzer ruft erstmals die App auf, er wird aufgefordert seinen Namen und seine Schrittlänge zu setzen.
    \item[/T300/] Der Nutzer importiert seine Vorgangsdaten aus einer CSV-Datei. Die Daten sind nun in den einzelnen Vorgängen sichtbar. %changed
