...
>>>>>>> Stashed changes
\newglossaryentry{Echtzeit}{name=Echtzeit, description={mit einer durch die Verarbeitung bedingten Verzögerung von bis zu 3 Sekunden zwischen dem Anfallen der (Roh-)Daten und der Ausgabe bzw. Visualisierung.}}
...
=======
  \textbf{Schritterkennung beim Gehen}%%bitte Namen der Funktionalen Anf. verwenden!!
>>>>>>> Stashed changes
  \begin{enumerate}
