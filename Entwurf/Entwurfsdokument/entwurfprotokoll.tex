...
\paragraph{Attribute}
\begin{itemize}
	\item [] \textbf{MenuPages: Dictionary<int, NavigationPage}\\ Dieses Dictionary wird verwendet, um mit dem Klicken auf den Namen einer bestimmten Page die Page selbst zu asoziieren.
