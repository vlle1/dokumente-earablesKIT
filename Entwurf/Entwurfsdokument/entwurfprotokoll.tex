...
Die Klasse EarablesConnection implementiert das IEarablesConnection Interface und ist die konkrete Klasse, die sich um die BLE-Verbindung kümmert.\\
	...
	\includegraphics[width=0.5\textwidth]{bilder/BibPackageKlassen/Constants.png}
...
\begin{minipage}[b]{0.5\textwidth}
	...
	\end{minipage}
	\begin{minipage}[c]{0.5\textwidth}
	\includegraphics[width=0.6\textwidth]{bilder/BibPackageKlassen/Gyroscope.png}
\end{minipage}
\paragraph{Klassenbeschreibung:}
...
\begin{minipage}[b]{0.5\textwidth}
	...
	\end{minipage}
	\begin{minipage}[c]{0.5\textwidth}
	\includegraphics[width=0.6\textwidth]{bilder/BibPackageKlassen/Accelerometer.png}
\end{minipage}
\paragraph{Klassenbeschreibung:}
...
\end{itemize}
	...
	\subsubsection{Class Characteristics}
		...
		\includegraphics[width=0.5\textwidth]{bilder/BibPackageKlassen/Characteristics.png}
