...
\end{minipage}
	...
	Dieses Enum spezifiziert alle möglichen Typen von Menüeinträgen der MenuPage. Entsprechend gibt es für jede vom Menü aus direkt navigierbare Page einen Wert dieses Enums. Wir orientieren uns hierbei an dem starndardmäßigen Entwurf für das Master-Detail Schema von Xamarin in der Entwicklungsumgebung Visual Studio 2019. \\
	\paragraph{Werte:}
	\begin{itemize}
        \item CountMode,
        \item DataOverview,
...
\clearpage
\section{Anhang}
\includepdf[fitpaper=true]{Diagramme/uebersicht/png2pdf.pdf}
%%\begin{center}
%%\includegraphics[width=1.4\textwidth, angle=-90]{./bilder/Anhang/View.png}\\
%%\includegraphics[width=1.47\textwidth, angle=-90]{./bilder/Anhang/ViewModel.png}\\
%%\includegraphics[width=1.47\textwidth, angle=-90]{./bilder/Anhang/Model.png}\\
%%\end{center}
