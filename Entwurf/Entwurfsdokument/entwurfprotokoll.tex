...
\begin{minipage}[b]{0.5\textwidth}
	...
	\includegraphics[width=0.6\textwidth]{bilder/BibPackageKlassen/EarablesConnection.png}
\end{minipage}
...
\begin{minipage}[b]{0.5\textwidth}
	...
	\end{minipage}
	\begin{minipage}[c]{0.5\textwidth}
	\includegraphics[width=0.6\textwidth]{bilder/BibPackageKlassen/LPF_Gyrosope.png}
\end{minipage}
...
\begin{minipage}[b]{0.5\textwidth}
	...
	\end{minipage}
	\begin{minipage}[c]{0.5\textwidth}
	\includegraphics[width=0.6\textwidth]{bilder/BibPackageKlassen/LPF_Accelerometer.png}
\end{minipage}
\paragraph{Klassenbeschreibung:}
...
\begin{minipage}[b]{0.5\textwidth}
	...
	\end{minipage}
	\begin{minipage}[c]{0.5\textwidth}
	\includegraphics[width=0.5\textwidth]{bilder/BibPackageKlassen/Gyroscope.png}
\end{minipage}
\paragraph{Klassenbeschreibung:}
...
\begin{minipage}[b]{0.5\textwidth}
	...
	\end{minipage}
	\begin{minipage}[c]{0.5\textwidth}
	\includegraphics[width=0.5\textwidth]{bilder/BibPackageKlassen/Accelerometer.png}
\end{minipage}
\paragraph{Klassenbeschreibung:}
...
\end{itemize}
	...
	\begin{minipage}[b]{0.6\textwidth}
		...
		\end{minipage}
		\begin{minipage}[c]{0.5\textwidth}
			\includegraphics[width=0.6\textwidth]{bilder/EMKlassen/ActivityArgsInterface.png}
		\end{minipage}
	...
	\begin{minipage}[b]{0.6\textwidth}
		...
		\end{minipage}
		\begin{minipage}[c]{0.5\textwidth}
			\includegraphics[width=0.6\textwidth]{bilder/EMKlassen/RunningEventArgsClass.png}
		\end{minipage}
	...
	\end{minipage}
	\begin{minipage}[c]{0.5\textwidth}
		\includegraphics[width=0.6\textwidth]{bilder/EMKlassen/CountableActivityArgsInterface.png}
	\end{minipage}
	...
	\begin{minipage}[b]{0.6\textwidth}
		...
		\end{minipage}
		\begin{minipage}[c]{0.5\textwidth}
			\includegraphics[width=0.6\textwidth]{bilder/EMKlassen/PushUpEventArgsClass.png}
		\end{minipage}
	\paragraph{Klassenbeschreibung:}
	...
	\begin{minipage}[b]{0.6\textwidth}
		...
		\end{minipage}
		\begin{minipage}[c]{0.5\textwidth}
			\includegraphics[width=0.6\textwidth]{bilder/EMKlassen/StepEventArgsClass.png}
		\end{minipage}
	\paragraph{Klassenbeschreibung:}
	...
	\begin{minipage}[b]{0.6\textwidth}
		...
		\end{minipage}
		\begin{minipage}[c]{0.5\textwidth}
			\includegraphics[width=0.6\textwidth]{bilder/EMKlassen/SitUpEventArgsClass.png}
		\end{minipage}
	\paragraph{Klassenbeschreibung:}
...
\includegraphics[width=0.4\textwidth]{bilder/EMKlassen/UserClass.png}
	\paragraph{Klassenbeschreibung:}
...
\begin{minipage}[c]{0.3\textwidth}
	\includegraphics[width=\textwidth]{bilder/ViewModelKlassen/BaseModeViewModel}
\end{minipage}
\paragraph{Klassenbeschreibung:}
...
\end{minipage}
\begin{minipage}[c]{0.3\textwidth}
	\includegraphics[width=\textwidth]{bilder/ViewModelKlassen/StepModeViewModel.png}
\end{minipage}
\paragraph{Klassenbeschreibung:}
...
\end{minipage}
\begin{minipage}[c]{0.3\textwidth}
	\includegraphics[width=\textwidth]{bilder/ViewModelKlassen/CountModeViewModel}
\end{minipage}
\paragraph{Klassenbeschreibung:}
...
\end{minipage}
\begin{minipage}[c]{0.3\textwidth}
	\includegraphics[width=\textwidth]{bilder/ViewModelKlassen/ListenAndPerformViewModel}
\end{minipage}
\paragraph{Klassenbeschreibung:}
...
\end{minipage}
\begin{minipage}[c]{0.3\textwidth}
	\includegraphics[width=\textwidth]{bilder/ViewModelKlassen/MusicModeViewModel}
\end{minipage}
\paragraph{Klassenbeschreibung:}
...
\end{minipage}
\begin{minipage}[c]{0.3\textwidth}
	\includegraphics[width=\textwidth]{bilder/ViewModelKlassen/DataOverviewViewModel}
\end{minipage}
