...
Ihre Kritik und Anmerkungen haben wir als Input genommen, um die App noch nutzerfreundlicher und besser zu machen.
...
\\ \\
Bedeutungen der Ergebnisse: \\
OK: In allen Testläufen erfolgreich\\
FAILED: In mindestens einem Testlauf nicht erfolgreich\\
NTB: Konnte nicht getestet werden\\
...
\begin{figure}[h]
	\centering
    \subfigure[App fordert den Nutzer, nach drücken des Buttons \glqq{Set Gyro Range}, auf einen Range für das Gyroscope auszuwählen]{\includegraphics[width=0.4\textwidth]{./bilder/BibTestApp/GyroRange.jpeg}}
\end{figure}
\FloatBarrier
